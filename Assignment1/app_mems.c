...
static void Accelero_Sensor_Handler(uint32_t Instance)
{
  ...
  {
    //snprintf(dataOut, MAX_BUF_SIZE, "\r\nACC_X[%d]: %d, ACC_Y[%d]: %d, ACC_Z[%d]: %d\r\n", (int)Instance, (int)acceleration.x, (int)Instance, (int)acceleration.y, (int)Instance, (int)acceleration.z);
      snprintf(dataOut, MAX_BUF_SIZE, "\r\n%d, %d, %d, ", (int)acceleration.x, (int)acceleration.y, (int)acceleration.z);
  }
...
static void Magneto_Sensor_Handler(uint32_t Instance)
{
  ...
  else
  {
    ...
    snprintf(dataOut, MAX_BUF_SIZE, "%d, %d, %d ", (int)magnetic_field.x,(int)magnetic_field.y, (int)magnetic_field.z);
  }
